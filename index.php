        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="card mb-4 shadow-sm">
                <div class="card-body text-center">
                  <a href="letra.php?letra=CC" class="btn btn-lg btn-bd-primary mb-3 mb-md-0 mr-md-3">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <a href="https://linkedin.com/in/joaopiva-dev" type="button" class="btn bd-btn-lg btn-bd-primary">
